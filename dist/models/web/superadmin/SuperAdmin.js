...
var SuperAdminSchema = new mongoose_1.default.Schema({
    name: {
        type: String,
    },
    email: {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    salt = _b.sent();
                    if (!(this.password && this.password.length > 0)) return [3 /*break*/, 3];
                    _a = this;
...
SuperAdminSchema.methods.comparePassword = function (canditatePassword) {
    return __awaiter(this, void 0, void 0, function () {
        var isMatch;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bcryptjs_1.default.compare(canditatePassword, this.password)];
                case 1:
                    isMatch = _a.sent();
